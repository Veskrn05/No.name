...
$email    = "";
$errors = array(); 
$db = mysqli_connect('localhost', 'romanveskrna4fan', 'Password1*', 'tabulkamereni');
      ...
      else
      {
          ...
          else
          {
              ...
              else
              {
                  ...
                  if (empty($email)) { array_push($errors, "Zadejte e-mail"); }
                  if (empty($password_1)) { array_push($errors, "Zadejte heslo"); }
