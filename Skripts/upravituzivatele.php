...
<body>
    <div class="hlavni">
        <h1>Úprava uživatele <?php echo $row_user['username']; ?></h1>
            <form action="updateuzivatele.php" method="GET" enctype="multipart/form-data">
                <table class="table">
                <tr>
                    <td>Uživatelské jméno:<tr><td><input class="insert" name="username" value="<?php echo $row_user['username']; ?>"></td></tr>
                </tr>
                <tr>
                    <td>E-mail:<tr><td><input class="insert" name="email" value="<?php echo $email; ?>" disabled></td></tr>
                </tr>

                <tr>
                    <td>Role:
                        <select name="role" class="insert">
                            <option <?php echo $role == 'Autor' ? 'selected' : ''; ?>>Autor</option>
                            <option <?php echo $role == 'Administrator' ? 'selected' : ''; ?>>Administrator</option>
                            <option <?php echo $role == 'Čtenář' ? 'selected' : ''; ?>>Čtenář</option>
                            <option <?php echo $role == 'Recenzent' ? 'selected' : ''; ?>>Recenzent</option>
                            <option <?php echo $role == 'Redaktor' ? 'selected' : ''; ?>>Redaktor</option>
                            <option <?php echo $role == 'Šéfredaktor' ? 'selected' : ''; ?>>Šéfredaktor</option>
                        </select>
                    </td>
                </tr>
            </table>
            ...
            <input type="submit" name="submit" class="ano" value="Zapiš změny">
             <a class="zpet" href="uzivatele.php">Zpět</a>
        </form>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">Opravdu chcete smazat uživatele <?php echo $row_user['username']; ?>?</h4>
                    </div>
