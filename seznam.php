...
<body>
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<tr><th>Náhled</th><th>Název</th><th>Autor</th><th>Datum</th></tr>";
        while($row = $result->fetch_assoc()) {
            echo "<tr>";
            $oc=$row["ID"];
            echo "<td style='height:5rem; width:10rem; text-align:center;'><img src='" . $row["fotka"] . "'></td>";
            echo "<td style='height:5rem; width:10rem; text-align:center;'><b><a class='odkaz' href='info.php?oc=$oc'>" . $row["nazev"] . "</a></b></td>";
            echo "<td style='height:5rem; width:10rem; text-align:center;'>" . $row["autor"] . "</td>";
            echo "<td style='height:5rem; width:10rem; text-align:center;'>" . $row["datum"] . "</td>";
            if($role =='Administrator'){
                echo "<td style='height:5rem; width:5rem;' align=center>"."<a class='odkaz' href='upravitclanek.php?oc=$oc'><b id='b'>Upravit</b></a></td>";
            }
            echo "</tr>";
        }
        echo "</table>";
